    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FaqID = table.Column<Guid>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestorId1 = table.Column<string>(nullable: true),
                    Question = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    ID = table.Column<Guid>(nullable: false),
                    ResponserId = table.Column<Guid>(nullable: false),
                    RespondedById = table.Column<string>(nullable: true),
                    Answer = table.Column<string>(nullable: true),
                    RequestForInfoID = table.Column<Guid>(nullable: false)
                },
                constraints: table =>
                {
